...
<style>
  ...
  .card-title { font-weight: 600; font-size: 17px; opacity: 0.9; }
  .card-value { font-size: 26px; font-weight: 700; }
  .card-value small { font-size: 16px; opacity: 0.9; }
  .card-footer {
    font-size: 0.9rem;
    ...
    <div class="col-12 col-md-6 col-lg-3">
      <div class="dashboard-card total-card mb-3">
        ...
        <div class="card-footer">
             ...
             H: {{ $totalHadir }} &nbsp;&nbsp; A: {{ $totalAlpha }} &nbsp;&nbsp; S: {{ $totalSakit }} &nbsp;&nbsp; I:20 &nbsp;&nbsp; T: {{ $totalTerlambat }}
      </div>
    </div>
          ...
          <form method="GET" action="{{ route('Filter.kelas') }}" class="filter-kelas">
            <div class="container-fluid">
              <div class="search-box mt-3 mb-4" style="margin-left:-20px; width:100%">
                <select name="kelas" class="form-control" width="100%">
